...
prefix_build="/c/mingw640/x86_64-640-win32-sjlj-rt_v5-rev0/mingw64/opt"
...
CFLAGS=$(echo "-O2 -pipe -fno-ident -I/c/mingw640/x86_64-640-win32-sjlj-rt_v5-rev0/mingw64/opt/include -I/c/mingw640/prerequisites/x86_64-zlib-static/include -I/c/mingw640/prerequisites/x86_64-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
